...
2.  **Mapa Interativo do Brasil (Em Dev):** Visualização de dados estatísticos por região para facilitar o diagnóstico social da violência.
...
* **Visualização de Dados:** Implementação de mapas interativos baseados em dados públicos.
* **Arquitetura:** Projeto de código aberto e domínio público para livre replicação por prefeituras e ONGs.
